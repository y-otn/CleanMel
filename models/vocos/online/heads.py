...
from models.vocos.offline.spectral_ops import IMDCT, ISTFT
from models.vocos.online.modules import symexp
...
class ISTFTHead(FourierHead):
    ...
    def forward(self, x: torch.Tensor, mag_recurrsive=None) -> torch.Tensor:
        """
