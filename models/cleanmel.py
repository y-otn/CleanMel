...
class CleanMel(nn.Module):
    ...
    def __init__(
        ...
        # Mel filterbank
        linear2mel = librosa.filters.mel(**_mel_options)
...
if __name__ == '__main__':
    ...
    import numpy as np
    from models.io.stft import InputSTFT
    from models.io.stft import TargetMel
    ...
    # vocos norm
    x = stft(torch.tensor(noisy).unsqueeze(0).float())
    x = x.to("cuda")
